import { GetCycles, GetReporters, Query1_6, Query1_7Tickets, Query2_1ByMonth, Query2_1ByYear, Query2_2ByYear, Query3_1ByMonth, Query3_1ByYear, Query4_1_1, Query4_1_2, Query4_1_3, Query4_1_4, Query4_2_1, Query4_2_2, Query5_1_1, Query5_1_1Tickets, Query5_1_2, Query5_1_2ByCycle, Query5_1_2Tickets } from './../../models/consulta';
...
export class ConsultaService {
  ...
  GetInternalInvoice(idUser : string, cycle : string, code : string) : Observable<Response<Query5_1_2Tickets[]>>{
    return this.http.get<Response<Query5_1_2Tickets[]>>(this.url + this.controller + '/GetInternalInvoice?idUser='+idUser+'&cycle='+cycle+'&code='+code);
  }
